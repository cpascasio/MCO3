...
const FlipNav = () => {
    ...
    return (
        <nav className="sticky w-full p-4 border-b-[1px] border-gray-200 flex items-center justify-between top-0 bg-e8b27a" style={{backgroundColor: 'white', zIndex: '10000'}}>
    ...
    return (
        ...
        >
            <motion.div whileHover={{ y: -30 }}>
                ...
                {/* hover color */}
                <span className="flex items-center h-[30px]" style={{ color: "#9c1a1d" }}>
          {text}
        </span>
            </motion.div>
        </a>
...
const MenuLink = ({ text, href }) => {
    return (
        ...
        >
            ...
            <motion.div whileHover={{ y: -30 }}>
                <span className="flex items-center h-[30px] text-gray-500">{text}</span>
                <span className="flex items-center h-[30px] text-indigo-600" style={{ color: "#9c1a1d" }}>
          {text}
        </span>
            </motion.div>
        </motion.a>
