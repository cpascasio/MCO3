                    ...
                    <div className="flex w-2/3 justify-end">
                        ...
                        <div className="helpful-btn1 border-2 border-[#885133] p-1 rounded-md ">
                            ...
                            <img
                                ...
                                src={
                                    helpfulClicked
                                        ? "../../../public/assets/mdi-helpful-outline-clicked.svg"
                                        : "../../../public/assets/mdi-helpful-outline.svg"
                                }
                        ...
                        <div className="nothelpful-btn1 border-2 border-[#885133] p-1 rounded-md">
                            ...
                            <img
                                ...
                                src={
                                    notHelpfulClicked
                                        ? "../../../public/assets/mdi-not-helpful-outline-clicked.svg"
                                        : "../../../public/assets/mdi-not-helpful-outline.svg"
                                }
